...
CREATE TABLE IF NOT EXISTS `filmratingdb`.`film` (
  ...
  `film_description` TEXT(1000) NULL COMMENT 'Описание сюжета фильма',
...
INSERT INTO `filmratingdb`.`user` (`id`, `username`, `password`, `email`, `name`, `lastname`, `birthdate`, `user_country`, `user_rating`, `isAdmin`, `isBanned`) VALUES (3, 'baffa', '0f6e4a1df0cf5ee97c2066953bed21b2', 'baffalo98@gmail.com', 'Ivan', 'Kustov', '1998-06-08', 3, NULL, 1, 0);
...
START TRANSACTION;
USE `filmratingdb`;
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (1, 'Jason', 'Statham', 1);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (2, 'Brad', 'Pitt', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (3, 'Jim', 'Carry', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (4, 'Sergey', 'Bezrukov', 4);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (5, 'Gerard', 'Depardieu', 5);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (6, 'Adriano', 'Celentano', 6);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (7, 'Scarlett', 'Johansson', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (8, 'Arnold', 'Schwarzenegger', 9);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (9, 'Sylvester', 'Stallone', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (10, 'Benedict', 'Cumberbatch', NULL);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (11, 'Ryan', 'Reynolds', 7);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (12, 'Chris', 'Hemsworth', 8);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (13, 'Tom', 'Hiddleston', 1);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (14, 'Robert', 'Downey Jr.', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (15, 'Tom', 'Holland', 1);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (16, 'Tim', 'Robbins', 1);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (17, 'Morgan', 'Freeman', 2);
INSERT INTO `filmratingdb`.`actor` (`actor_id`, `actor_name`, `actor_surname`, `actor_country`) VALUES (18, 'Michael', 'Keaton', 2);
