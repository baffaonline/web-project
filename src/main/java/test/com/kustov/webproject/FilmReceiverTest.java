...
//                0, false, UserType.USER), "Whenever I talk about this movie with my friends, I do not " +
...
//                " a 13!!!!!!", "Simply known as \"The Movie\"", 8, 0, 0));
...
//                30),
//                new Country(1, "England"), 0, false, UserType.USER), "I have never seen such " +
...
//                "favorite movie.", "Prepare to be moved", 9, 0, 0));
    ...
    public void findFilmByIWrongId() throws ServiceException{
        FilmReceiver receiver = new FilmReceiver();
        Film actual = receiver.findFilmById(4);
